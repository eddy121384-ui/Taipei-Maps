(()=>{
  ...
  // Canonical runtime dataset for Taipei-Maps school catchments.
  // 115學年度 exact pilot: official school assignment semantics joined to official 鄰 geometry.
  // Rendering code lives in school-district-layer.js; future parsers should generate/update this module.
  const dataset={
    academicYear:115,
    jurisdiction:'臺北市',
    coverage:{
    ...
    sources:{
      assignment:{
        authority:'臺北市教育局',
        description:'115學年度里鄰學區 assignment'
      },
      geometry:{
        authority:'臺北市民政局',
