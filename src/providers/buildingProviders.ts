...
export const BUILDING_PROVIDERS = {
  ...
  newTaipeiNlsc: {
    ...
    verified: true,
    notes: "NLSC I3S layer 5. Dedicated smoke test confirmed broad New Taipei urban coverage.",
  },
  taipeiCadastral: {
    ...
    verified: true,
    notes: "Optional detail provider with cadastral/building attributes; coverage differs from the full-city LOD1 layer.",
  },
